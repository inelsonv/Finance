...
export function quincenaDeFecha(fecha) {
  ...
  return { year: y, month: m, quincena: d <= 15 ? "Q1" : "Q2" };
}
...
export function consumoPresupuesto({ presupuesto, movimientos, categoria, year, month, quincena }) {
  ...
  for (const m of movimientos) {
    ...
    const q = quincenaDeFecha(m.date);
